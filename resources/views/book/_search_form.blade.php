    ...
    <div class="col-md-12" style="background-color: #eee; padding:10px; padding-top:20px; border-radius:10px">
        <div class="row">
            <div class="col-md-4 mb-8">
                {{ Form::select('levels', App\Models\BookLevel::getBookLevels(),
                request()->get('levels'),
            ...
            <div class="col-md-6 mb-8">
                <div class="form-group">
                    {{ Form::select('book_title', App\Models\BookInventory::pluck('book_name', 'id'),
                    request()->get('book_title'), ['class' =>
                    'form-control select2',
                    'placeholder'=>'--All Books--', 'style'=>'width:100%']) }}
                </div>
            </div>
